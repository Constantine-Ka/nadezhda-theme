...
document.querySelectorAll('.scene-Elem').forEach((elem) => {
    ...
    console.log("🚀 ~ file: index.html ~ line 343 ~ document.querySelectorAll ~ modifier", modifier)
...
function sborPod_emnick(){
	...
	document.querySelector('p.d-flex.justify-content-start.justify-content-lg-center.align-items-center').innerText=amount+" руб.("+totalPercent+"%)"
}
